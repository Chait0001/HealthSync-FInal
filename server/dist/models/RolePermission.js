...
const rolePermissionSchema = new mongoose_1.Schema({
    ...
    permission_id: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Permission', required: true },
    permission_key: { type: String, required: true },
    effect: { type: String, enum: ['allow', 'deny'], default: 'allow' },
    assigned_by: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User' },
}, { timestamps: true });
rolePermissionSchema.index({ role_id: 1, permission_id: 1 }, { unique: true });
exports.RolePermissionModel = mongoose_1.default.model('RolePermission', rolePermissionSchema);
